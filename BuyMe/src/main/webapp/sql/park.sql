...
create table request_comment(
 ...
 constraint request_comment_fk2 foreign key (request_num) references request_board (req_num)
);
...
create table request_inquiry(
 ...
 constraint request_inquiry_fk2 foreign key (request_num) references request_board (req_num)
);
