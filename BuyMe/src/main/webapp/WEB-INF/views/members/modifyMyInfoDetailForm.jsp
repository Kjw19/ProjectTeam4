...
<div class="page-main">
	...
	<div class="myContent-main">
		<div class="mypage-div">
			...
			<div class="detail-input"> <!-- 간단 내 정보 시작 -->
				<ul>
					<li>
						<h2>내 상세 정보 수정</h2>
